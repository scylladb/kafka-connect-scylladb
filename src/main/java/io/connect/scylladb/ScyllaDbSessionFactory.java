...
public class ScyllaDbSessionFactory {
  ...
  public ScyllaDbSession newSession(ScyllaDbSinkConnectorConfig config) {
    ...
    if (!config.loadBalancingLocalDc.isEmpty()) {
      ...
      driverConfigLoaderBuilder.withClass(DefaultDriverOption.LOAD_BALANCING_POLICY_CLASS, DefaultLoadBalancingPolicy.class);
    } else {
    ...
    if (config.sslEnabled) {
      ...
      if (null != config.trustStorePath) {
        ...
        driverConfigLoaderBuilder
            ...
            .withString(DefaultDriverOption.SSL_TRUSTSTORE_PASSWORD, Arrays.toString(config.trustStorePassword));
      }
      ...
      if (null != config.keyStorePath) {
        ...
        driverConfigLoaderBuilder
            ...
            .withString(DefaultDriverOption.SSL_KEYSTORE_PASSWORD, Arrays.toString(config.keyStorePassword));
      }
  ...
  private void configureAddressTranslator(ScyllaDbSinkConnectorConfig config, CqlSessionBuilder sessionBuilder, ProgrammaticDriverConfigLoaderBuilder configBuilder) {

...
This quickstart will show how to setup the ScyllaDB Connector against a Dockerized ScyllaDB.
...
``https://github.com/patitapaban19/kafka-connect-scylladb``
...
When not running Integration Tests and after project build completion a folder by the name of ‘components’ will be created in the target folder of the source code folder.
The jar files are present in {source-code-folder}/target/components/packages/[jar-files]
